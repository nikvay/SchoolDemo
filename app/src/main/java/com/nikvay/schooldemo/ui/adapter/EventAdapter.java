...
import com.nikvay.schooldemo.domain.module.EventModule;
import com.nikvay.schooldemo.domain.network.BaseApi;
import com.nikvay.schooldemo.ui.activity.EventDetailsActivity;
...
public class EventAdapter extends RecyclerView.Adapter<EventAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        final String senderName = eventModule.getUser_name();
