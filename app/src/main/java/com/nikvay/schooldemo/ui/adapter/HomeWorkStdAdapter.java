...
import com.nikvay.schooldemo.ui.activity.HomeWorkDetailsActivity;
import com.squareup.picasso.Picasso;

import java.util.ArrayList;

public class HomeWorkStdAdapter extends RecyclerView.Adapter<HomeWorkStdAdapter.MyViewHolder> implements Filterable {
    ...
    public HomeWorkStdAdapter(Context mContext, String url, ArrayList<HomeWorkListModule> homeWorkListStudentModuleArrayList) {
        this.url = url;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        String time = homeWorkListModule.getTime();
...
*/
        ...
        holder.ll_hide_homework_class.setVisibility(View.GONE);
    ...
    public int getItemCount() {
        return /*homeWorkListStudentModuleArrayList == null ? 0 : */homeWorkListStudentModuleArrayList.size();
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView txt_subject_name, txt_description, txt_submit_date,txt_class_div_name,txt_home_work_time_t;
           LinearLayout ll_hide_homework_class;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            ll_hide_homework_class = itemView.findViewById(R.id.ll_hide_homework_class);
